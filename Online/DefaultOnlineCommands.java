...
public class DefaultOnlineCommands {
    /**
     * Void messages are generally not used, but a typeless message would be sent
     * this way
     */
    public static final String VOID = "v;";
    /**
     * Simple text messages are meant to only contain text and no other commands or
     * data
     */
    public static final String SIMPLE_TEXT = "st;";
    /**
     * Identifier for a request message, where the caller is asking for something
     * about the other
     * This command is proceeded by a flag that indicates what the caller is asking
     * for (requesting)
     */
    public static final String REQUEST = "req;";
    /**
     * Identifier for an answer to a request packet. Packets of this form must
     * contain an answer in some fashion for
     * what the request packet was asking for. This command is proceeded by a flag
     * that indicates what it is sending
     * back,as well as an IDIdentifier that contains the ID of the original request
     * that was saved to ensure that the
     * requester knows what this packet is answering to
     */
    public static final String ANSWER = "ans;";
    /**
     * Flag that is used to communicate that this packet contains or is asking for
     * an ID
     */
    ...
    /**
     * Identifier that the sender of this packet requests that the recipient assigns
     * the data of the packet in some way or form.
     */
    ...
    /**
     * converts a UUID to a IDIdentifier, which is an UUID in the form of a command
     * identifier
     * 
